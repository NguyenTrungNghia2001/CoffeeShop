...
namespace CoffeeShop.Areas.Admin.Controllers
{
    public class KHUYENMAIsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDKM,TENKM,GIAMGIA")] KHUYENMAI kHUYENMAI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDKM,TENKM,GIAMGIA")] KHUYENMAI kHUYENMAI)
        {
            if (ModelState.IsValid)
            {
