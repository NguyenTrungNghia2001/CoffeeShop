...
namespace CoffeeShop.Areas.Admin.Controllers
{
    public class SANPHAMsController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "MASP,TENSP,LOAISP,IDNL,SLUONG,HINHANH,ImageFile,GIASP,DiaChiCH,Mota")] SANPHAM sANPHAM)
        {
            if(sANPHAM != null && sANPHAM.ImageFile != null)
            {
                string filename = Path.GetFileNameWithoutExtension(sANPHAM.ImageFile.FileName);
                string extension = Path.GetExtension(sANPHAM.ImageFile.FileName);
                filename = filename + DateTime.Now.ToString("yymmssfff") + extension;
